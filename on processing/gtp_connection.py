...
class GtpConnection():
    ...
    def move_to_point(self,move):
        ...
        point = point_to_coord(coord[0],coord[1],size)
        return point
    ...
    def end_game(self,args):
        if self.place != None:
            ...
            for step in [1,self.board.NS,self.board.NS-1,aelf.board.NS+1]:
    ...
    def play_cmd(self, args):
        ...
        try:
            ...
            # check coordinate
            board_move = args[1]
            if  move_to_coord(args[1], self.board.size):
